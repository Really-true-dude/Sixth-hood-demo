...
define gui.text_font = "gui/vhs.ttf"

## Шрифт, используемый именами персонажей.
define gui.name_text_font = "gui/vhs.ttf"

## Шрифт, используемый текстом вне игры.
define gui.interface_text_font = "gui/vhs.ttf"
...
define gui.main_menu_background = Movie(play = "gui/overlay/menu_bg.ogv", loop = True, size=(1920,1080))

...
screen main_menu():
    ...
    imagemap:
        ground Movie(play = "gui/overlay/menu_bg.ogv", loop = True, size=(1920,1080))
        idle "gui/overlay/menu_buttons.png"
        hover "gui/overlay/menu_buttons_hover.png"

        hotspot(100, 200, 350, 80) action Start()
        hotspot(100, 330, 490, 80) action ShowMenu("load")
        hotspot(100, 445, 500, 80) action ShowMenu("preferences")
        hotspot(100, 575, 420, 80) action ShowMenu("about")
        hotspot(100, 840, 340, 80) action Quit()
